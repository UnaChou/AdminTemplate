...
namespace Resources
{
    ...
    internal class Resource
    {
        ...
        /// <summary>
        ///   查詢類似 http://AdminTemplate.omg.com.tw 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 AdminTemplate.omg.com.tw 的當地語系化字串。
        /// </summary>
        internal static string Domain_Cookies
        {
            get
            {
                return ResourceManager.GetString("Domain_Cookies", resourceCulture);
            }
        }

        /// <summary>
        ///   查詢類似 127.0.0.1 的當地語系化字串。
        /// </summary>
        internal static string SMTPIP
        {
            get
            {
                return ResourceManager.GetString("SMTPIP", resourceCulture);
            }
        }

        /// <summary>
        ///   查詢類似 /UploadFiles 的當地語系化字串。
        /// </summary>
